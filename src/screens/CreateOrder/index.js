  ...
  static navigationOptions = ({ navigation }) => ({
    header: () => {
      const backToHome = navigation.state.params ?
        ...
        : true
      return (
        <HeaderDefault title="确认订单" backToHome={backToHome} navigation={navigation} />
      )
    }
  })
        ...
        <Content>
                    ...
                    >
                      <View style={{width: 120}}>
                        <Image
                          ...
                          resizeMode="cover"
                          source={{uri:  cartDetail.good.imageUrl ? JSON.parse(JSON.stringify(cartDetail.good.imageUrl).replace('https:','http:')) : null}}
                        />
                      </View>
                      <View style={{flex: 1}}>
                        <Text numberOfLines={2} style={{fontSize: 20}}>
                          {cartDetail.good.goodsName}
                        </Text>
          ...
          <List style={{backgroundColor: '#fff', marginTop: 20}}>
            ...
            <ListItem icon>
              ...
              <Right>
                <MyIcons name="information" fontSize="30" />
              </Right>
            </ListItem>
            <ListItem>
              <Text>
